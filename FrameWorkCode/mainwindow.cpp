...
{
    QString superText = ui->textBrowser->textCursor().selectedText();
    ui->textBrowser->textCursor().removeSelectedText();
    ui->textBrowser->insertHtml(QString("<sup>%1</sup>").arg(superText));
}
...
void MainWindow::on_actionSubscript_triggered()
{
    QString superText = ui->textBrowser->textCursor().selectedText();
    ui->textBrowser->textCursor().removeSelectedText();
    ui->textBrowser->insertHtml(QString("<sub>%1</sub>").arg(superText));
